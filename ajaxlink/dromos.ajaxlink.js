...
define(["jquery", "jqueryui"], function($jQ)
{
    $jQ.widget('dromos.ajaxLink',
    {
        options : {
            ...
            /**
             * Gets the target that the loaded content will be appended to
             */
            getTarget : function(){return this.element;},
            ...
            method : 'GET',
            // The event to bind to for loading the ajax content, mouseover is default
            loadEvent: 'mouseover',
        ...
        _create : function()
        {
            ...
            if (this.options.loadEvent === 'load')
            {
                this._loadContent();
            }
            else
            ...
            loJQElement.click(dromos.utilities.createCallback(function(toEvent)
                {
                    ...
                    return this.options.onClick.call(this, toEvent);
        ...
        onSuccess : function(toData)
        {
            ...
            if (lcTarget === "_blank")
            {
                ...
                if (!this._target)
                {
                    ...
                    this._targetContainer.hide();
                    $jQ(this.options.getTarget.call(this)).append(this._targetContainer);
